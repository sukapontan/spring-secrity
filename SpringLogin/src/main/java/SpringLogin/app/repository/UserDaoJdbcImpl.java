...
//        Map<String, Object> getMap = jdbc.queryForMap("SELECT * FROM user where user_id = 1");
//        String getObject = jdbc.queryForObject("SELECT user_name FROM user where user_id = 1", String.class);
